...
name = 'j16_grip_64_6_f623_print_final'
...
for i in range(14, n_frame):
  ...
  f.write('  Scale 2.7 2.7 2.7\n')
  f.write('  Translate -0.5 -0.4 0\n')
  ...
  # Rendering.
  os.system('../../../src/bin/pbrt --ncores 36 --outfile %s/%s_%03d.exr %s.pbrt' % (root_folder, name, i, name))
