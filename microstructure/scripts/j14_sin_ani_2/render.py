...
root_folder = '/home/ubuntu/external/j14_sin_ani_2/rendering'
...
for i in range(n_start, n_end + 1):
  # Rendering.
  os.system('../../../src/bin/pbrt --ncores 36 --outfile %s/j14_sin_ani_2_%03d.exr %d/j14_sin_ani_2.pbrt' % (root_folder, i, i))
